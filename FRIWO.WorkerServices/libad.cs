...
namespace FRIWO.WorkerServices
{
    static class LIBAD
    {
        ...
        [DllImport("libad4", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libad4", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ad_ioctl")]
        ...
        [DllImport("libad4", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ad_get_product_info")]
